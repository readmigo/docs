...
```
匿名订阅流程：
1. 用户在 Apple/Google 完成支付
2. 收据存储在本地 Keychain/SharedPreferences
3. 每次启动时验证本地收据
4. 订阅状态与设备绑定
...
├── 书架内容 (UserBook)
├── 阅读进度 (ReadingSession)
├── 书签/高亮/笔记 (Bookmark, Highlight, Note)
├── 词汇库 (VocabularyEntry)
├── 学习统计 (DailyStats)
├── 成就徽章 (UserBadge)
└── 用户偏好 (User profile fields)
```

...
```mermaid
graph TD
    PR["PR 提交"] --> Lint["Lint<br>ktlint + detekt"]
    Lint --> UnitTests["Unit Tests<br>./gradlew test"]
    UnitTests --> Coverage["Coverage<br>Jacoco 报告"]
    Coverage --> Build["Build<br>./gradlew assembleDebug"]
```

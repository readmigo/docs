...
graph TD
    subgraph Collection["数据采集层"]
        Crashlytics["Crashlytics<br>崩溃监控"]
        MetricKit["MetricKit<br>系统指标"]
        CustomTracking["自定义<br>埋点"]
    end
    ...
    MetricKit --> Processing
    CustomTracking --> Processing
    Processing --> Firebase
    Processing --> Sentry
    Processing --> CustomPlatform
```

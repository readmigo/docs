...
```mermaid
flowchart LR
    A["React Native<br>EPUBReader"] -->|"postMessage"| B["WebView<br>EPUB.js"]
    B -->|"onMessage"| A
```
...
```mermaid
flowchart TD
    A["Book Detail"] -->|"点击阅读"| B["Load EPUB<br>URL/Content"]
    B --> C["WebView<br>Initialize"]
    C --> D["Rendering<br>EPUB.js"]
    D --> E["Go To Last<br>Location"]
    C --> E
    E --> F["Reading<br>Session"]
```

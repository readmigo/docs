...
graph LR
    subgraph arch["2 环境架构"]
        A["Local<br>开发者本地环境<br>localhost:3000"] -->|部署| B["Production<br>生产环境<br>api.readmigo.app"]
        A --> C["本地 PostgreSQL<br>本地 Redis<br>R2 readmigo-dev"]
        B --> D["Neon PostgreSQL<br>Upstash Redis<br>R2 readmigo-prod"]
    end
```

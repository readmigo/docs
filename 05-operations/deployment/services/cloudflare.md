...
│  收件地址路由:                                                  │
│                                                                  │
│  support@readmigo.app  ───────▶  [管理员邮箱]                   │
│  hello@readmigo.app    ───────▶  [管理员邮箱]                   │
│  feedback@readmigo.app ───────▶  [管理员邮箱]                   │
│  dmarc@readmigo.app    ───────▶  [DMARC 报告邮箱]               │
│                                                                  │
│  Catch-all (*@)        ───────▶  [管理员邮箱]                   │
│                                                                  │
│  邮件验证记录:                                                  │
...
│                                                                  │
│  证书配置:                                                      │
│  ├── Edge Certificate: Cloudflare 自动签发                     │

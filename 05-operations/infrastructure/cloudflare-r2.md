...
│  │         │                │                │                 ││
│  │         ▼                ▼                ▼                 ││
│  │  cdn.readmigo.app  staging-cdn...  debug-cdn...            ││
│  │  (自定义域名)       (R2.dev)        (R2.dev)                ││
│  │                                                              ││
│  └─────────────────────────────────────────────────────────────┘│
│                                                                  │
...
│           ▼                                                      │
│  ┌─────────────────┐                                            │
│  │  Job Server     │  (Digital Ocean Droplet)                   │
│  │                 │                                            │
│  │  ├── 下载 EPUB                                               │
│  │  ├── 解析内容                                                │
│  │  ├── 提取封面                                                │
...
│  │  Response                           │                       │
│  │  {                                  │                       │
│  │    coverUrl: "cdn.../cover.jpg",   │                       │
│  │    epubUrl: "signed-url...",       │  (签名URL)            │
│  │  }                                  │                       │
│  └─────────────────────────────────────┘                       │
│           │                                                      │
│           │  3. 直接从 R2 下载                                  │

...
│                                                             │
│  audiobooks 表扩展:                                          │
│  ├── reading_level: Float      // Flesch-Kincaid 级别       │
│  ├── grade_level: String       // 适合年级 (K-12)           │
│  ├── word_count: Int           // 总字数                    │
│  └── source: 'LIT2GO'          // 来源标识                  │
│                                                             │
│  audiobook_chapters 表扩展:                                  │
│  ├── word_count: Int           // 章节字数                  │
│  └── text_pdf_url: String      // PDF 文本 URL              │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```

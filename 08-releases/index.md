...
| 版本 | 目标 | 时间 |
|------|------|------|
| **V1.0** (Foundation) | 电子书 MVP | 2025 Q1 |
| **V2.0** (Audio) | 有声书 + Android | 2025 Q2 |
| **V3.0** (Smart) | 智能阅读增强 + Web | 2025 Q3 |
| **V4.0** (Import) | 用户内容导入 | 2025 Q4 |
| **V5.0** (Community) | 社区与创作 | 2026 Q1 |
...
| 文档 | 描述 |
|------|------|
| [release-history.md](./history/release-history.md) | 版本发布历史记录 |
...
- **版本规划**: roadmap/complete-version-roadmap.md
- **发布历史**: history/release-history.md
- **版本迁移**: version-migration-guide.md

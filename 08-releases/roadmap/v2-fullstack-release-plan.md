...
│   Phase 2: 清洗数据库                                             │
│   ┌─────────────────────────────────────────────────────────┐   │
│   │  • 识别非 SE 来源书籍（source != 'standard-ebooks'）      │   │
│   │  • 删除非 SE 书籍的 Chapter 记录                          │   │
│   │  • 删除非 SE 书籍的 ReadingProgress 记录                  │   │
│   │  • 删除非 SE 书籍的 Highlight 记录                        │   │
│   │  • 删除非 SE 书籍的 Book 记录                             │   │
│   │  • 清理孤立的 Author 记录                                 │   │
│   └─────────────────────────────────────────────────────────┘   │
│                              │                                    │
...
│   │  • 对比数据库保留的 book-id                               │   │
│   │  • 删除不在列表中的 EPUB 文件                             │   │
│   │  • 删除对应的封面图片（covers/books/）                    │   │
│   └─────────────────────────────────────────────────────────┘   │
│                              │                                    │
│                              ▼                                    │
│   Phase 4: 重新导入 SE 书籍                                       │
│   ┌─────────────────────────────────────────────────────────┐   │
│   │  • 运行 SE Content Pipeline                               │   │
│   │  • 导入全部 SE 书籍（1000+本）                            │   │
│   │  • 上传 EPUB 到 R2                                        │   │
│   │  • 上传封面到 R2                                          │   │
│   └─────────────────────────────────────────────────────────┘   │

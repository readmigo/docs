...
│  │                                                                   │    │
│  │  ┌───────────┐ ┌───────────┐ ┌───────────┐ ┌───────────┐        │    │
│  │  │ CMU Book  │ │ WikiPlots │ │  BookSum  │ │ Fandom    │        │    │
│  │  │ Summary   │ │           │ │ (章节级)  │ │ Wikis     │        │    │
│  │  └───────────┘ └───────────┘ └───────────┘ └───────────┘        │    │
│  │         ↓             ↓             ↓             ↓              │    │
│  │  ┌───────────────────────────────────────────────────────┐      │    │
...
│  │                                                                   │    │
│  │  解析规则示例:                                                    │    │
│  │  ├── 时间正则: /(\d{4}年|\d+月|\d+日|春天|冬天|三年后...)/        │    │
│  │  ├── 转折词检测: /然而|但是|突然|最终|直到.../                    │    │
│  │  └── 人物词典: {角色名: 角色ID}                                   │    │
│  │                                                                   │    │
│  └─────────────────────────────────────────────────────────────────┘    │
│                                    ↓                                     │
...
│  │  3. 首句/末句作为事件标题候选                                     │    │
│  │  4. 关键词匹配事件类型:                                           │    │
│  │     - "死亡|去世|离世" → CHARACTER (人物退场)                     │    │
│  │     - "发现|揭露|真相" → DISCOVERY                                │    │
│  │     - "战斗|冲突|对抗" → CONFLICT                                 │    │
│  │     - "转变|改变|决定" → TURNING_POINT                            │    │
│  │                                                                   │    │
│  └─────────────────────────────────────────────────────────────────┘    │
│                                                                          │
│  可覆盖书籍: Project Gutenberg 公版书 (数千本)                          │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
...
│                                                                          │
│  ┌───────────────────┐  ┌───────────────────┐  ┌───────────────────┐   │
│  │   公开数据集导入   │  │  规则化文本解析   │  │   人工标注平台    │   │
│  │   - CMU Dataset   │  │  - 时间正则      │  │   - 编辑后台     │   │
│  │   - BookSum       │  │  - 关键词匹配    │  │   - 审核流程     │   │
│  │   - WikiPlots     │  │  - 段落分割      │  │   - 质量控制     │   │
│  └───────────────────┘  └───────────────────┘  └───────────────────┘   │
│                                                                          │
